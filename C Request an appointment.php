	...
	<span style="background-color:white;">
		<table style="margin-top: -9px;margin-left: -7px; width: 105%; border-collapse:collapse; background-color:white" >
							<tr>
								...
								<td width=15.6%  height: 30px;><a   style="text-decoration: none; color: #44475c;"href="C previous appointments.php">View previous appointments</a></td><!--was C Previous appointments.html-->
