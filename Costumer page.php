    ...
    <?php
        ...
        <table style="margin-left:10px;">
                    <tr>
                        ...
                        <td width=15.6%><a href="C Previous appointments.html"><!-- <img height="30" width="30" alt="View previous appointments here" src="5896962.png"> --> View previous appointments</a></td>
